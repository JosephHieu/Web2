...
<header id="header" style="background:#fff;">
    ...
    <div>
        <ul id="icons">
            ...
            <li id="menu" id="lg-bag"><a href="shop.php"><i class="fa-solid fa-cart-shopping"></i></a></li>
            <li id="menu" id="lg-user"><a href="register.php" id="userlogin"><i class="fa-regular fa-circle-user fa-lg" ></i></a></li>
...
<section class="commercial-index" >
    <img src="images/Bừng khí chất.jpg" alt="kiến trúc cho tương lai" style="width: 100%;">
</section>
